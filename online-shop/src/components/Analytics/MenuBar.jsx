...
export const MenuBar = ({callback, products}) => {
  ...
  return (
    ...
    <div className="flex flex-col justify-between h-5/6 w-2/12 p-4 mr-1 ml-3 rounded-lg border-2 bg-gradient-to-b from-green-100 to-emerald-100 border-green-700">   
