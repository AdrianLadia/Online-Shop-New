  ...
  return (
    <div className="bg-gray-100 min-h-screen flex items-center justify-center">
      <div className="bg-white shadow-lg p-8 rounded-md w-full md:w-96">
        <div className="text-center">
          ...
          >
            <path
              ...
              strokeWidth={2}
              d="M10 9a1 1 0 011-1h2a1 1 0 110 2h-2a1 1 0 01-1-1zm0 4a1 1 0 011-1h2a1 1 0 110 2h-2a1 1 0 01-1-1zM6 18L18 6M6 6l12 12"
            />
          </svg>
        ...
        <button
          className="mt-6 bg-yellow-500 text-white w-full py-2 rounded-md hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-opacity-50"
          onClick={handleHome}
        >
          Return to Shop
        </button>
