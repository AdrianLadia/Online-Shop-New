  ...
  return (
    <div className="w-full">
      <div className='bg-green-300  flex justify-center'>
          <button onClick={onWholesaleClick} className=' mr-2 mt-5 flex-none w-auto p-3 border rounded-full bg-green-100 lg:w-40 hover:bg-green-500 hover:animate-pulse' >
            Wholesale
          </button>
          <button onClick={onRetailClick} className='mt-5 flex-none w-auto p-3 border rounded-full bg-green-100 lg:w-40 hover:bg-green-500 hover:animate-pulse' >
            Retail
          </button>
      </div>
